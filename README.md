...
Коли ми обробляємо POST і PUT у контролері вище, нам також потрібно отримати доступ до тіла запиту. Роблячи це, ми можемо використовувати його для заповнення нашої імпровізованої бази даних.
